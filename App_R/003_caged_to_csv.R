...
# diretóro pessoal
path <- setwd("D://Usuários/Rodrigo/GoogleDrive/Compartilhado/UFRGS_TCC/CAGED/microdados/compactado/2010/")

# diretóro trabalho
#path <- setwd("C://Users//rodrigo.ferreira//Google Drive//Compartilhado//UFRGS_TCC//CAGED//microdados//compactado//2019/")
...
for (i in 1:length(file.list)){
  ...
  df.tratado <- df[c("Admitidos.Desligados", "Ano.Declarado", "Competência.Declarada"
               ...
               , "Sexo", "Salário.Mensal", "Qtd.Hora.Contrat", "Tipo.Mov.Desagregado")]
